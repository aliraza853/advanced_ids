...
def get_alerts():
    ...
    return pd.DataFrame(columns=["timestamp", "src_ip", "dst_port", "location", "blocked", "attempt_count"])
...
def create_location_chart(df):
    ...
    fig = px.bar(
        ...
        title="Top 10 Locations of Suspicious IPs",
        labels={'x': 'Location', 'y': 'Number of Alerts'},
